  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center">
        {/* Logo with glow */}
        <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-amarillo animate-logo-glow mb-6">
          <Image
        ...
        {/* Title */}
        <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-white mb-2 text-shadow-hard">
          EL TACO CHINGON
        </h1>
