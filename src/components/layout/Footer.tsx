        ...
        <div className="mt-8 pt-6 border-t border-gray-700">
          <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-[#FF1A1A] hover:bg-[#D32323] text-white rounded-lg flex items-center justify-center transition-colors"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-[#FF3008] hover:bg-[#E02800] text-white rounded-lg flex items-center justify-center transition-colors"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-linear-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90 text-white rounded-lg flex items-center justify-center transition-opacity"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-lg flex items-center justify-center transition-colors"
